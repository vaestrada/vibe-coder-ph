...
/**
 * Gen AI to Z — Day 0 (Event Day) Email CLI
 *
 * Usage:
 *   node scripts/send-day0.mjs              # Dry run (shows count)
 *   node scripts/send-day0.mjs --test email  # Send test to specific email
 *   node scripts/send-day0.mjs --send        # Mass send to all registrants
 *   node scripts/send-day0.mjs --send --skip N  # Skip first N registrants
 *
 * Environment:
...
const endpoint = `${baseUrl}/api/send-day0`;
...
console.log("\n🚀 Gen AI to Z — It's TODAY! Day 0 Email\n");
