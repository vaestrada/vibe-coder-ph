...
import { Mail, Calendar, MapPin, ArrowLeft } from "lucide-react";
      ...
      <div className="max-w-lg w-full">
        ...
        <div className="bg-card/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8 text-center">
          ...
          <div className="relative mb-8">
            <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 flex items-center justify-center">
            ...
            <div className="absolute top-0 right-1/4 w-3 h-3 rounded-full bg-violet-400 animate-ping" />
            <div className="absolute bottom-2 left-1/4 w-2 h-2 rounded-full bg-fuchsia-400 animate-ping" style={{ animationDelay: "0.5s" }} />
          </div>

          {/* Title */}
          <h1 className="text-3xl font-bold mb-3 bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent">
            Check Your Email!
          </h1>
          ...
          <p className="text-muted-foreground mb-8">
            Click the link in the email to confirm your registration. The link expires in <strong className="text-foreground">24 hours</strong>.
          </p>

          {/* Tips */}
          <div className="bg-white/5 rounded-xl p-4 mb-8 text-left">
            <h3 className="text-sm font-semibold mb-2 text-foreground">Didn&apos;t receive it?</h3>
          ...
          <div className="bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 border border-violet-500/20 rounded-xl p-4 mb-8">
            <h3 className="text-sm font-semibold mb-3 text-foreground">Event Details</h3>
...
export default function SuccessPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-b from-background via-violet-950/20 to-background flex items-center justify-center">
